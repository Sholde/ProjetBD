...
/* Film */
insert into Film values (1, "The Matrix", "Science-Fiction - Action", 120, "USA", "all","../img/affiche1.jpg","https://www.youtube.com/watch?v=8xx91zoASLY","Programmeur anonyme dans un service administratif le jour, Thomas Anderson devient Neo la nuit venue. A cheval entre deux mondes, Neo est assailli par d'étranges songes et des messages cryptés provenant d'un certain Morpheus. Celui-ci l'exhorte à aller au-delà des apparences et à trouver la réponse à la question qui hante constamment ses pensées : qu'est-ce que la Matrice ? Mais Morpheus est persuadé que Neo est l'Elu, le libérateur mythique de l'humanité annoncé selon la prophétie. Ensemble, ils se lancent dans une lutte sans retour contre la Matrice et ses terribles agents...");
insert into Film values (2, "The Matrix reloaded", "Science-Fiction - Action", 120, "USA", "all","../img/affiche2.jpg","https://www.youtube.com/watch?v=0ha2XYVC7_s","Neo apprend à mieux contrôler ses dons naturels, alors même que Sion s'apprête à tomber sous l'assaut de l'Armée des Machines. D'ici quelques heures, 250 000 Sentinelles programmées pour anéantir notre espèce envahiront la dernière enclave humaine de la Terre. Mais Morpheus galvanise les citoyens de Sion en leur rappelant la Parole de l'Oracle : il est encore temps pour l'Elu d'arrêter la guerre contre les Machines");
insert into Film values (3, "The Matrix revolution", "Science-Fiction - Action", 120, "USA", "all","../img/affiche3.jpg","https://www.youtube.com/watch?v=sK51m1tj_bE","La longue quête de liberté des rebelles culmine en une bataille finale explosive. Tandis que l'armée des Machines sème la désolation sur Zion, ses citoyens organisent une défense acharnée. Mais pourront-ils retenir les nuées implacables des Sentinelles en attendant que Neo s'approprie l'ensemble de ses pouvoirs et mette fin à la guerre ?");
insert into Film values (4, "The social network", "Biographie - Drame", 120, "USA", "all","../img/affiche4.jpg","https://www.youtube.com/watch?v=-3CVdY4MkdM","Une nuit d'automne 2003, l'étudiant de Harvard et génie de l'informatique Mark Zuckerberg est assis derrière son ordinateur et travaille fiévreusement sur un nouveau projet. Par un mélange de blog et de programmation, l'aventure commencée dans une chambre d'étudiant devient bientôt un réseau");
insert into Film values (5, "V for Vendetta", "Action", 120, "USA", "vf","../img/affiche5.jpg","https://www.youtube.com/watch?v=hmbQgEHGpLg","Une nuit, alors que 'deux gardiens de l'ordre' s'apprêtent à la violer dans une rue déserte, Evey est sauvé par un mystérieux libérateur. Après cela, tout va changer pour elle : son apprentissage commence sous la tutelle de 'V' tandis que la révolution est en marche...");
insert into Film values (6, "Die hard", "Action", 120, "USA", "vo","../img/affiche6.jgp","https://www.youtube.com/watch?v=IBX_A-5iWYA","Bruce Willis reprend son rôle le plus mythique, celui de John McClane -- le « vrai héros » qui a le talent et la trempe de celui qui résiste jusqu'au bout. Cette fois-ci, le flic sans état d'âme est vraiment au mauvais endroit au mauvais moment, à Moscou, pour aider son fils Jack qu'il ne voit plus. Entre la mafia russe qui veut leur faire la peau et leur combat pour éviter le déclenchement d'une guerre, les McClane découvrent que leurs méthodes pourtant bien différentes font d'eux des héros que rien ne peut arrêter.");
insert into Film values (7, "Die hard 2", "Action", 120, "USA", "vo","../img/affiche7.jgp","https://www.youtube.com/watch?v=dC9UCRMxoZg","L'inspecteur de police McClane attend que l'avion de son épouse atterrisse dans un aéroport international proche de Washington. D'étranges allers et venues attirent son attention. Il suit des hommes qui communiquent discrètement entre eux jusqu'au sous-sol de l'aéroport. Là, des inconnus tirent sur lui et des mercenaires prennent le contrôle de l'aeroport, coupant toute communication avec l'extérieur. Les passagers des avions prêts a l'atterrissage, dont la femme de McClane, n'ont plus que cinquante-huit minutes pour vivre !");
insert into Film values (8, "Die hard 3", "Action", 120, "USA", "vo","../img/affiche8.jpg","https://www.youtube.com/watch?v=PoKYB26wH_Q","Le policier de 'Piège de cristal' et de '58 minutes pour vivre' John McClane (Bruce Willis) pensait en avoir fini avec les terroristes internationaux et pourtant, ce jour-là, il allait vivre la journée la plus dure de sa vie. Simon (Jeremy Irons - Fatale), un fou dangereux, fait exploser l'un des plus grands magasins de New York et menace de faire sauter d'autres lieux si McClane ne joue pas à son jeu dont les règles sont simples : répondre, dans un temps très court, à ses énigmes. Faute de quoi des bombes exploseront. Avec l'aide de Zeus (Samuel L.Jackson - Pulp Fiction), ils devront réfléchir vite pour éviter le pire et retrouver Simon afin de mettre un terme à cette terreur. La course à travers New York commence... ");
insert into Film values (9, "Die hard 4", "Action", 120, "USA", "vo","../img/affiche9.jpg","https://www.youtube.com/watch?v=_KISjPFvleg","Pour sa quatrième aventure, l'inspecteur John McClane se trouve confronté à un nouveau genre de terrorisme. Le réseau informatique national qui contrôle absolument toutes les communications, les transports et l'énergie des Etats-Unis, est détruit de façon systématique, plongeant le pays dans le chaos. Le cerveau qui est derrière le complot a tout calculé à la perfection. Ou presque... Il n'avait pas prévu McClane, un flic de la vieille école qui connait deux ou trois trucs efficaces pour déjouer les attaques terroristes.");
