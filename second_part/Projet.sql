...
INSERT INTO `Cinema` VALUES ('Ciné-Sel','Sel','Sèvres'),('Pathé Boulogne','Pathé Gaumont','Boulogne');
...
INSERT INTO `Film` VALUES (1,'The Matrix','Science-Fiction - Action',120,'USA','all'),(2,'The Matrix reloaded','Science-Fiction - Action',120,'USA','all'),(3,'The Matrix revolution','Science-Fiction - Action',120,'USA','all'),(4,'The social network','Biographie - Drame',120,'USA','all'),(5,'V for Vendetta','Action',120,'USA','vf'),(6,'Die hard','Action',120,'USA','vo'),(7,'Die hard 2','Action',120,'USA','vo'),(8,'Die hard 3','Action',120,'USA','vo'),(9,'Die hard 4','Action',120,'USA','vo');
...
INSERT INTO `Note` VALUES (1,1,3),(1,4,3),(4,5,1),(4,6,2),(4,8,1),(6,3,5),(10,7,4),(12,2,2),(14,7,2),(18,5,5),(20,4,3),(20,6,3),(21,1,3),(21,4,4),(22,5,4),(32,5,1),(34,1,3),(37,9,2),(41,3,4),(45,4,2),(50,1,5),(55,1,5),(55,7,2),(67,4,2),(99,4,5),(101,3,3),(112,3,3),(133,8,1),(139,3,4),(144,1,4),(152,1,3),(152,4,4),(152,8,3),(157,2,4);
...
INSERT INTO `Personne` VALUES (1,'Reeves','Keanu',55),(2,'Fishburne','Laurence',58),(3,'Wachowski','Lilly',62),(4,'Wachowski','Lana',60),(5,'Moss','Carrie-Anne',62),(6,'Fincher','David',57),(7,'Sorkin','Aaron',58),(8,'Eisenberg','Jesse',36),(9,'Garfield','Andrew',36),(10,'Timberlake','Justin',38),(11,'McTeigue','James',52),(12,'Weaving','Hugo',59),(13,'Portman','Natalie',38),(14,'Graves','Rupert',56),(15,'McTierman','John',68),(16,'Willis','Bruce',62),(17,'Stuart','James',63),(18,'Rickman','Alan',69);
...
INSERT INTO `Salle` VALUES (1,'Ciné-Sel',30),(1,'Pathé Boulogne',30),(2,'Pathé Boulogne',30);
...
INSERT INTO `Suit` VALUES (1,2),(2,3),(6,7),(7,8),(8,9);
...
CREATE TABLE `Veut_voir` (
  ...
  KEY `num_se_joue` (`num_se_joue`),
  KEY `num_client` (`num_client`),
  KEY `num_film` (`num_film`),
  CONSTRAINT `Veut_voir_ibfk_1` FOREIGN KEY (`num_se_joue`) REFERENCES `Se_joue_dans` (`num_se_joue`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `Veut_voir_ibfk_2` FOREIGN KEY (`num_client`) REFERENCES `Clients` (`num_client`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `Veut_voir_ibfk_3` FOREIGN KEY (`num_film`) REFERENCES `Film` (`num_film`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
