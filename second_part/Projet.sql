...
-- Généré le :  Mar 17 Décembre 2019 à 15:54
...
INSERT INTO `Cinema` (`nom`, `compagnie`, `ville`) VALUES
('Ciné-Sel', 'Sel', 'Sèvres'),
('Pathé Boulogne', 'Pathé Gaumont', 'Boulogne');
...
(2, 2, 'Acteur'),
(2, 3, 'Acteur'),
(3, 1, 'Directeur - Scénariste'),
(3, 2, 'Directeur - Scénariste'),
(3, 3, 'Directeur - Scénariste'),
(3, 5, 'Scénariste'),
(4, 1, 'Directeur - Scénariste'),
(4, 2, 'Directeur - Scénariste'),
(4, 3, 'Directeur - Scénariste'),
(4, 5, 'Scénariste'),
(5, 1, 'Acteur'),
(5, 2, 'Acteur'),
(5, 3, 'Acteur'),
...
INSERT INTO `Salle` (`num_salle`, `nom_du_cinema`, `nb_de_place`) VALUES
(1, 'Ciné-Sel', 30),
(1, 'Pathé Boulogne', 30),
(2, 'Pathé Boulogne', 30);
...
INSERT INTO `Se_joue_dans` (`num_se_joue`, `jour`, `version`, `num_film`, `num_salle`, `nom_du_cinema`) VALUES
(1, '2019-12-18 10:00:00', 'vf', 1, 1, 'Pathé Boulogne'),
(2, '2019-12-18 10:00:00', 'vo', 6, 2, 'Pathé Boulogne'),
(3, '2019-12-18 15:00:00', 'vf', 2, 1, 'Pathé Boulogne'),
(4, '2019-12-18 16:00:00', 'vf', 5, 2, 'Pathé Boulogne'),
(5, '2019-12-18 10:00:00', 'vf', 4, 1, 'Ciné-Sel'),
(6, '2019-12-18 15:00:00', 'vf', 5, 1, 'Ciné-Sel'),
(7, '2019-12-19 09:00:00', 'vf', 3, 1, 'Pathé Boulogne'),
(8, '2019-12-19 11:00:00', 'vf', 1, 1, 'Ciné-Sel'),
(9, '2019-12-20 17:00:00', 'vf', 4, 1, 'Pathé Boulogne'),
(10, '2019-12-20 17:00:00', 'vo', 6, 1, 'Ciné-Sel'),
(11, '2019-12-21 14:00:00', 'vo', 2, 1, 'Ciné-Sel'),
